...
describe('ChatMessage', () => {
  ...
  it('collapses all tool calls but keeps thought bubbles expanded when streaming is finished', () => {
    ...
    // Thought step (index 0) is expanded (isCollapsed=false)
    expect(headers[0].querySelector('.lucide-chevron-down')).not.toBeNull();
