...
- **Title:** Sourced from `branding.notificationTitle` (provider-specific, e.g., "Claude", "Gemini")
...
```json
{
  "notificationTitle": "Claude"  // Shown in desktop notification title bar
}
```

**Examples:**
- Claude provider: `"notificationTitle": "Claude"`
- Gemini provider: `"notificationTitle": "Gemini"`
- Kiro provider: `"notificationTitle": "Kiro"`
...
Get settings from useSystemStore:
  ...
  - branding: { notificationTitle: "Claude" }
    ↓
